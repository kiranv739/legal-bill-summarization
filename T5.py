...
model_path = "google/flan-t5-large"  # Replace with your actual fine-tuned model path
...
def summarize_chunk(chunk_tensor):
    try:
        ...
        prompt = "summarize:" + input_text.strip()
...
def process_bill(pdf_path):
    ...
    full_summary = "\n\n".join(summaries)
    out_path = Path("summaries_flant5") / f"{pdf_path.stem}.txt"
